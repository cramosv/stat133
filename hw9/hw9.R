...
optionlist <- list( hAxis ="{title: 'Displacement'}",
vAxis="{title:'MPG'}",
title="Car Model vs. Car Displacement")
...
WorldDat=WorldDat[apply(WorldDat,1,FUN=function(x)any(is.na(x))==FALSE),]
...
Motion <- gvisMotionChart(data=WorldDat,idvar="country",timevar="year",xvar="life.expectancy",yvar="fertility.rate",colorvar="region",sizevar="population")
